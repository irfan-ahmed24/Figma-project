...
function Banner() {
  return (
    <div className="position-relative">
      <img className="Banner-bg" src="../background/banner-bg.png" alt="Banner Background" height="1000px" width="100%" />
        ...
        <div className="container py-5 mt-5">
          <div className="text-center text-dark py-5 px-4">
            ...
            <div className="d-flex justify-content-center align-items-center gap-3 mt-4">
              <button className="button-2">Get Started Free</button>
              <button className="button-1">Get Started Free</button>
            </div>
          </div>
          <div className="position-relative">
            <img className="z-1" src="./contentImages/content-1.png" alt="" width="100%"/>
