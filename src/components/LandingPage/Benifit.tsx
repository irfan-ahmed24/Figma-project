      ...
      <div className="container py-5">
        <header className="text-center mx-0 mx-md-5 px-0 px-md-5 mb-5 pb-3">
          <div className="mx-0 mx-xl-5 px-0 px-xl-5">
            <h2 className="display-6 fw-bold mx-0 mx-lg-5 px-0 px-lg-5 text-dark">
              Transform Your Business With
              <span className="text-primary"> AI-Powered Automation</span>
            </h2>
            <p className="text-muted mx-0 mx-lg-5 px-0 px-lg-5">
              A catchy subtitle goes here to further explain the value
            ...
            <div className="card shadow-sm large-feature-card">
              <div className="row g-4 align-items-center">
                <div className="col-lg-6 p-5">
                  ...
                  <h2 className="h3 fw-bold mt-2 mb-3">
              ...
              <div className="col-lg-6">
                <div className="card h-100 shadow-sm small-feature-card">
                  <div className="col-12 p-5">
                    ...
                    <h2 className="h4 fw-bold mt-2 mb-3">
                      Resolve 70% of customer questions. **Instantly.**
                    </h2>
                    <p className="text-muted">
                      Resolve live chat queues, and start auto-resolving issues.
                    </p>
                  </div>
